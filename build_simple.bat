...
%PYTHON% -m PyInstaller --noconfirm --clean --onedir --windowed --name "K-Trader" --icon "assets\K-Trader.ico" --add-data "src;src" --hidden-import "PyQt5.QtWidgets" --hidden-import "PyQt5.QAxContainer" --hidden-import "PyQt5.QtCore" --hidden-import "PyQt5.QtGui" --hidden-import "src.engine" --hidden-import "src.ui_dashboard" --hidden-import "src.setup_wizard" --hidden-import "src.config_manager" --hidden-import "src.notifications" --hidden-import "src.database" --hidden-import "src.market_calendar" --hidden-import "src.ipc" --hidden-import "src.utils" --hidden-import "src.styles" --hidden-import "src.web_monitor" --hidden-import "src.backtest" --hidden-import "cryptography" --hidden-import "cryptography.fernet" --hidden-import "requests" --hidden-import "flask" main.py
if %errorlevel% neq 0 ( echo ERROR: K-Trader build failed & pause & exit /b 1 )
echo OK

echo [4/5] Building Setup Wizard...
%PYTHON% -m PyInstaller --noconfirm --clean --onefile --windowed --name "K-Trader Setup Wizard" --icon "assets\K-Trader.ico" --hidden-import "PyQt5.QtWidgets" --hidden-import "PyQt5.QtCore" --hidden-import "PyQt5.QtGui" --hidden-import "src.utils" --hidden-import "requests" --add-data "src;src" src\setup_wizard.py
if %errorlevel% neq 0 ( echo ERROR: Setup Wizard build failed & pause & exit /b 1 )
echo OK

echo [5/5] Setting up dist...
